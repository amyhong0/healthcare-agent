...
async def chat_endpoint(request: ChatRequest):
    try:
        ...
        model1 = genai.GenerativeModel("gemini-1.5-flash", system_instruction=analyzer_prompt)
        ...
        model2 = genai.GenerativeModel("gemini-1.5-flash", system_instruction=coach_prompt)
